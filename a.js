...
for (var di = 0; di < 99999; di += 200) {
    ...
    setTimeout(() => {
        ...
        if (x >= dx+34 && x <= dx+36 && dy-1 <= y && dy+1 >= y){
            h--;
            if (h == 0) {
                document.getElementById('lod').
                    style.display = 'inline-block'
                document.getElementById('ch').
                    style.display = 'none'
                x = 0;
        ...
        if (dz % 3 == 0) {
            dz++;
            document.getElementById('dch1').style.display = ""
            document.getElementById('dch2').style.display = "none"
        }
        else {
            dz++;
            document.getElementById('dch1').style.display = "none"
            document.getElementById('dch2').style.display = ""
        }
        if ((x-34.5) > dx) {
            dx++;
...
console.log('dy='+dy)
console.log('dx='+dx)
        document.getElementById('dch').style.marginLeft = (dx *2) + 69 + '%'
        document.getElementById('dch').style.marginTop = (dy) + 17 + '%'
    }, di);
}
